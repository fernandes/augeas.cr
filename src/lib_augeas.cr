...
lib LibAugeas
  ...
  enum AugFlags
    AUG_NONE                 =  0x0
    AUG_SAVE_BACKUP          =  0x1
    AUG_SAVE_NEWFILE         =  0x2
    AUG_TYPE_CHECK           =  0x3
    AUG_NO_STDINC            =  0x4
    AUG_SAVE_NOOP            =  0x5
    AUG_NO_LOAD              =  0x6
    AUG_NO_MODL_AUTOLOAD     =  0x7
    AUG_ENABLE_SPAN          =  0x8
    AUG_NO_ERR_CLOSE         =  0x9
    AUG_TRACE_MODULE_LOADING = 0x10
  end
  ...
  fun aug_init(root : LibC::Char*, loadpath : LibC::Char*, flags : LibC::UInt) : Augeas*
  ...
  fun aug_defvar(augeas : Augeas*, name : LibC::Char*, expr : LibC::Char*) : LibC::Int
  ...
  fun aug_defnode(augeas : Augeas*, name : LibC::Char*, expr : LibC::Char*, value : LibC::Char*, created : LibC::Int*) : LibC::Int
  ...
  fun aug_get(augeas : Augeas*, path : LibC::Char*, value : LibC::Char**) : LibC::Int
  ...
  fun aug_label(augeas : Augeas*, path : LibC::Char*, label : LibC::Char**) : LibC::Int
  ...
  fun aug_set(augeas : Augeas*, path : LibC::Char*, value : LibC::Char*) : LibC::Int
  ...
  fun aug_setm(augeas : Augeas*, base : LibC::Char*, sub : LibC::Char*, value : LibC::Char*) : LibC::Int
  ...
  fun aug_span(augeas : Augeas*, path : LibC::Char*, filename : LibC::Char**,
               label_start : LibC::UInt*, label_end : LibC::UInt*,
               value_start : LibC::UInt*, value_end : LibC::UInt*,
               span_start : LibC::UInt*, span_end : LibC::UInt*) : LibC::Int
  ...
  fun aug_insert(augeas : Augeas*, path : LibC::Char*, label : LibC::Char*, before : LibC::Int) : LibC::Int
  ...
  fun aug_rm(augeas : Augeas*, path : LibC::Char*) : LibC::Int
  ...
  fun aug_mv(augeas : Augeas*, src : LibC::Char*, dst : LibC::Char*) : LibC::Int
  ...
  fun aug_cp(augeas : Augeas*, src : LibC::Char*, dst : LibC::Char*) : LibC::Int
  ...
  fun aug_rename(augeas : Augeas*, src : LibC::Char*, lbl : LibC::Char*) : LibC::Int
  ...
  fun aug_match(augeas : Augeas*, path : LibC::Char*, matches : LibC::Char***) : LibC::Int
  ...
  fun aug_save(augeas : Augeas*) : LibC::Int
  ...
  fun aug_load(augeas : Augeas*) : LibC::Int
  ...
  #                   const char *path);
  fun aug_text_store(augeas : Augeas*, lens : LibC::Char*, node : LibC::Char*, path : LibC::Char*) : LibC::Int
  ...
  #                     const char *node_out);
  fun aug_text_retrieve(augeas : Augeas*, lens : LibC::Char*, node_in : LibC::Char*, path : LibC::Char*, node_out : LibC::Char*) : LibC::Int
  ...
  fun aug_escape_name(augeas : Augeas*, in : LibC::Char*, out : LibC::Char**) : LibC::Int
  ...
  fun aug_print(augeas : Augeas*, lens : FILE*, path : LibC::Char*) : LibC::Int
  ...
  fun aug_source(augeas : Augeas*, path : LibC::Char*, file_path : LibC::Char**) : LibC::Int
  ...
  fun aug_preview(augeas : Augeas*, path : LibC::Char*, out : LibC::Char**) : LibC::Int
  ...
  #               unsigned int flags);
  fun aug_to_xml(augeas : Augeas*, path : LibC::Char*, xmldoc : XmlNode**, flags : LibC::UInt) : LibC::Int
  ...
  fun aug_transform(augeas : Augeas*, lens : LibC::Char*, file : LibC::Char*, excl : LibC::Int) : LibC::Int
  ...
  fun aug_load_file(augeas : Augeas*, file : LibC::Char*) : LibC::Int
  ...
  fun aug_srun(augeas : Augeas*, out : FILE*, text : LibC::Char*) : LibC::Int
  ...
  fun aug_close(augeas : Augeas*) : Nil
  ...
  fun aug_ns_attr(augeas : Augeas*, var : LibC::Char*, i : LibC::Int, value : LibC::Char**, label : LibC::Char**, file_path : LibC::Char**) : LibC::Int
  ...
  fun aug_ns_label(augeas : Augeas*, var : LibC::Char*, i : LibC::Int, label : LibC::Char**, index : LibC::Int*) : LibC::Int
  ...
  #                 const char **value);
  fun aug_ns_value(augeas : Augeas*, var : LibC::Char*, i : LibC::Int, value : LibC::Char**) : LibC::Int
  ...
  fun aug_ns_count(augeas : Augeas*, var : LibC::Char*) : LibC::Int
  ...
  fun aug_ns_path(augeas : Augeas*, var : LibC::Char*, i : LibC::Int, path : LibC::Char**) : LibC::Int
  ...
  fun aug_error_minor_message(augeas : Augeas*) : LibC::Char*
  ...
  fun aug_error_details(augeas : Augeas*) : LibC::Char*
end
